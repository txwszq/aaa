...
public class FriendParamUtils {
	...
	public static List<NameValuePair> checkAddOfpmd(String distQQ, String qqNum) {
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		String qzreferrer = "http://user.qzone.qq.com/" + qqNum + "/myhome/friends/ofpmd";
		params.add(new BasicNameValuePair("qzreferrer", qzreferrer));
		params.add(new BasicNameValuePair("sid", "0"));
		params.add(new BasicNameValuePair("ouin", distQQ));
		params.add(new BasicNameValuePair("uin", qqNum));
	...
	public static List<NameValuePair> addQQOfpmd(String distQQ, String qqNum, String gtk, Boolean flag) {
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		String qzreferrer = "http://user.qzone.qq.com/" + qqNum + "/myhome/friends/ofpmd";
		params.add(new BasicNameValuePair("qzreferrer", qzreferrer));
		params.add(new BasicNameValuePair("sid", "0"));
		...
		if (flag) {
			params.add(new BasicNameValuePair("strmsg", "你好啊 " + distQQ));
		}
		...
		params.add(new BasicNameValuePair("from_source", "0"));
		return params;
	}
	 ...
	 */
	public static List<NameValuePair> shuoshuoParam(String content, String qqNum, String picUrl)
			throws UnsupportedEncodingException {
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		...
		params.add(new BasicNameValuePair("format", "fs"));
		params.add(new BasicNameValuePair("hostuin", qqNum));
		params.add(new BasicNameValuePair("paramstr", "1"));
		params.add(new BasicNameValuePair("pic_bo", ""));
		params.add(new BasicNameValuePair("pic_template", "13"));
		params.add(new BasicNameValuePair("qzreferrer", "http://user.qzone.qq.com/" + qqNum + "/311"));
		params.add(new BasicNameValuePair("richtype", "1"));
		params.add(new BasicNameValuePair("richval", "url=" + URLEncoder.encode(picUrl, "utf-8")
				+ "&width=400&height=250&pic_type=3&who=2"));
		params.add(new BasicNameValuePair("special_url", ""));
		params.add(new BasicNameValuePair("subrichtype", "3"));
		params.add(new BasicNameValuePair("syn_tweet_verson", ""));
		params.add(new BasicNameValuePair("to_sign", "0"));
		params.add(new BasicNameValuePair("to_tweet", "0"));
		params.add(new BasicNameValuePair("ugc_right", "1"));
		params.add(new BasicNameValuePair("ver", "1"));
		return params;
	}
	 ...
	 * @return
	 */
	public static List<NameValuePair> sendLog(String title, String content, String qqNum, String gtk) {
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("autograph", "1"));
		params.add(new BasicNameValuePair("blogType", "0"));
		params.add(new BasicNameValuePair("cate", "个人日记"));
		params.add(new BasicNameValuePair("feeds", "1"));
		params.add(new BasicNameValuePair("format", "fs"));
		params.add(new BasicNameValuePair("g_tk", gtk));
		params.add(new BasicNameValuePair("hostUin", qqNum));
		params.add(new BasicNameValuePair("html", content));
		params.add(new BasicNameValuePair("inCharset", "utf-8"));
		params.add(new BasicNameValuePair("iNotice", "1"));
		params.add(new BasicNameValuePair("json", "1"));
		params.add(new BasicNameValuePair("lp_flag", "0"));
		params.add(new BasicNameValuePair("lp_id", "81177"));
		params.add(new BasicNameValuePair("lp_style", "16843520"));
		params.add(new BasicNameValuePair("lp_type", "0"));
		params.add(new BasicNameValuePair("outCharset", "utf-8"));
		params.add(new BasicNameValuePair(
				"qzreferrer",
				"http://ctc.qzs.qq.com/qzone/newblog/v5/editor.html#opener=refererurl&source=1&refererurl=http://ctc.qzs.qq.com/qzone/app/blog/v6/bloglist.html#nojump=1&page=1&catalog=list"));
		params.add(new BasicNameValuePair("ref", "qzone"));
		params.add(new BasicNameValuePair("rightType", "1"));
		params.add(new BasicNameValuePair("secverifykey", "28Q1206" + qqNum + "_" + qqNum));
		params.add(new BasicNameValuePair("source", "1"));
		params.add(new BasicNameValuePair("title", title));
		params.add(new BasicNameValuePair("topFlag", "0"));
		params.add(new BasicNameValuePair("tweetFlag", "0"));
		params.add(new BasicNameValuePair("uin", qqNum));
		return params;
	}
	 ...
	 * @return
	 */
	public static List<NameValuePair> zhuanZaiLog(String destQQ, String blogid, String qqNum, String gtk) {
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair(
				"qzreferrer",
				"http://b1.cnc.qzone.qq.com/cgi-bin/blognew/blog_output_data?uin="
						...
						+ "&blogid="
						+ blogid
						+ "&styledm=cnc.qzonestyle.gtimg.cn&imgdm=cnc.qzs.qq.com&bdm=b.cnc.qzone.qq.com&mode=2&numperpage=15&timestamp="
						+ new Date().getTime()
						+ "&dprefix=cnc.&blogseed=0.30464689375070275&inCharset=utf-8&outCharset=utf-8&ref=qzone&entertime="
						+ new Date().getTime()));
		params.add(new BasicNameValuePair("uin", qqNum));
		params.add(new BasicNameValuePair("hostUin", destQQ));
		params.add(new BasicNameValuePair("blogId", blogid));
		params.add(new BasicNameValuePair("cateName", "个人日记"));
		params.add(new BasicNameValuePair("rightType	", "1"));
		params.add(new BasicNameValuePair("force", "0"));
		params.add(new BasicNameValuePair("source	", "34"));
		params.add(new BasicNameValuePair("iNotice", "1"));
		params.add(new BasicNameValuePair("inCharset", "gbk"));
		params.add(new BasicNameValuePair("outCharset", "gbk"));
		params.add(new BasicNameValuePair("format	", "fs"));
		...
		params.add(new BasicNameValuePair("json	", "1"));
		params.add(new BasicNameValuePair("g_tk	", gtk));
		params.add(new BasicNameValuePair("secverifykey", "28Q1206" + qqNum + "_" + destQQ));
		return params;
	}
	
	/**
	 * 转发说说
	 * @param destQQ 被转发说说的QQ
	 * @param tid 说说的TID
	 * @param qqNum 转载qq号
	 * @return
	 */
	public static List<NameValuePair> zhuanfaShuoShuo(String destQQ, String tid, String qqNum) {
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair(
				"qzreferrer","http://user.qzone.qq.com/"+destQQ));
		params.add(new BasicNameValuePair("tid", tid));
		params.add(new BasicNameValuePair("t1_source", "1"));
		params.add(new BasicNameValuePair("t1_uin", destQQ));
		params.add(new BasicNameValuePair("signin", "0"));
		params.add(new BasicNameValuePair("con	", ""));
		params.add(new BasicNameValuePair("with_cmt", "0"));
		params.add(new BasicNameValuePair("fwdToWeibo", "0"));
		params.add(new BasicNameValuePair("forward_source", "3"));
		params.add(new BasicNameValuePair("code_version", "1"));
		params.add(new BasicNameValuePair("format", "fs"));
		params.add(new BasicNameValuePair("out_charset", "UTF-8"));
		params.add(new BasicNameValuePair("hostuin", qqNum));
		return params;
	}
}
